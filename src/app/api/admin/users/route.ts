...
import { hasPermission, canAddUser, SUBSCRIPTION_LIMITS } from '@/lib/permissions'
  ...
  try {
    ...
    if (userRole === 'SUPER_ADMIN') {
      ...
      const limits = subscription
        ? SUBSCRIPTION_LIMITS[subscription.plan]
      ...
      const maxAllowed = role === 'SUB_ADMIN' ? limits.maxSubAdmins : limits.maxAgents
