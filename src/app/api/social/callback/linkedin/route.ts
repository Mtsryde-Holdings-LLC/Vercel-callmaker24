...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const displayName = `${userData.localizedFirstName || ''} ${userData.localizedLastName || ''}`.trim()
    ...
    return NextResponse.redirect(`${process.env.NEXTAUTH_URL}/dashboard/social?connected=LinkedIn&username=${displayName}`)
  } catch (error) {
