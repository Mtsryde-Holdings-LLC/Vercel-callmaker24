...
function AuthErrorPageContent() {
  ...
  const errorMessages: Record<string, string> = {
    ...
    OAuthSignin:
      "Error constructing the OAuth authorization URL. Please try again.",
    OAuthCallback: "Error handling the response from the OAuth provider.",
    OAuthCreateAccount:
      "Could not create an OAuth provider account. The email may already be linked to another sign-in method.",
    OAuthAccountNotLinked:
      "This email is already associated with another sign-in method. Please sign in using your original method (email/password, Google, or Facebook).",
