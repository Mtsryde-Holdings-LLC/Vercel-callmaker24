      ...
      {showCreate && (
        <div className="bg-white rounded-lg shadow-lg p-6">
          <h2 className="text-xl font-bold mb-4">
            {editingId ? "Edit" : "Create"} IVR Template
          </h2>
      ...
      {templates.length === 0 && !showCreate && (
        <div className="bg-gray-50 rounded-lg p-8 text-center">
          <p className="text-gray-600">
            No templates yet. Initialize defaults or create your own.
          </p>
        </div>
      )}
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-gray-900">
                    {templates.find((t) => t.id === previewId)?.type}
                  </p>
                </div>
                <div>
                  <label className="text-sm font-medium text-gray-600">
                  ...
                  <p className="text-gray-900 whitespace-pre-wrap bg-gray-50 p-4 rounded-lg">
                    {templates.find((t) => t.id === previewId)?.script}
                  </p>
                </div>
                <div>
                  <label className="text-sm font-medium text-gray-600">
                  ...
                  <div className="flex flex-wrap gap-2 mt-2">
                    {(
                      templates.find((t) => t.id === previewId)?.variables || []
                    ).map((v: string) => (
                      <span
                        key={v}
