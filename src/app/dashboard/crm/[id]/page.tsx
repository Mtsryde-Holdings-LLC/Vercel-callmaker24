...
export default function CRMContactDetailPage() {
  ...
  const fetchContactDetails = async () => {
    try {
      ...
      // Fetch customer orders (check if this is a customer)
      const customerResponse = await fetch(`/api/customers/${contactId}`)
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6 pt-6 border-t">
              <div>
                ...
                {isEditing ? (
                  ...
                  <p className="text-gray-900 font-medium mt-1">{contact.email}</p>
                )}
              </div>
              <div>
                ...
                {isEditing ? (
                  ...
                  <p className="text-gray-900 font-medium mt-1">{contact.phone}</p>
                )}
              </div>
              <div>
                <label className="text-sm text-gray-500">Deal Value</label>
                <p className="text-gray-900 font-medium mt-1">${contact.dealValue.toLocaleString()}</p>
              </div>
            </div>
          </div>
        </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      {isEditing ? (
                        ...
                        <p className="text-gray-900">{contact.website || 'Not provided'}</p>
                      )}
                    </div>
                  </div>
                </div>
