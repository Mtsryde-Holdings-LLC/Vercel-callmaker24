        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Discover how CallMaker24 transforms your customer engagement with AI-powered SMS, email, and call center solutions
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-12">
            ...
            <p className="text-gray-600 mb-6">
              Watch our comprehensive demo to see how CallMaker24 streamlines your communication workflow, 
              automates customer engagement, and drives measurable results.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            <div className="bg-white rounded-xl shadow-lg p-6">
              ...
              <p className="text-gray-600">
                Create and send professional email campaigns with advanced templates and tracking
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              ...
              <p className="text-gray-600">
                Send personalized text messages at scale with AI-powered automation
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              ...
              <p className="text-gray-600">
                Manage customer calls with AWS Connect integration and AI routing
              </p>
            </div>

            <div className="bg-white rounded-xl shadow-lg p-6">
              <div className="text-4xl mb-4">🤖</div>
              <h3 className="text-xl font-bold text-gray-900 mb-2">AI Chatbots</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              <div className="text-4xl mb-4">🛒</div>
              <h3 className="text-xl font-bold text-gray-900 mb-2">Shopify Integration</h3>
              <p className="text-gray-600">
      ...
      <footer className="bg-gray-900 text-white py-8 mt-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="mt-4 flex justify-center gap-6">
            ...
            <a href="tel:+16125408684" className="text-gray-400 hover:text-white">
              612-540-8684
            </a>
          </div>
        </div>
