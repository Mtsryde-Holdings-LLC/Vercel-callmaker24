...
export const metadata: Metadata = {
  ...
  description:
    "CallMaker24 Terms of Service — the agreement governing your use of our platform.",
};
          ...
          <div className="prose prose-gray max-w-none space-y-8 text-gray-700 leading-relaxed">
            ...
            <section>
              <p>
                ...
                to and use of the CallMaker24 platform and services (the
                &ldquo;Service&rdquo;) provided by Mtsryde Holdings LLC
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-1 mt-2">
                ...
                <li>
                  Have the legal authority to enter into these Terms on behalf
                  of yourself or the entity you represent.
                </li>
                <li>
                  Agree to comply with all applicable local, state, national,
            ...
            <section>
              ...
              <p>
                CallMaker24 is an all-in-one business communication and
            ...
            <section>
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 mt-3">
                <ul className="list-disc pl-6 space-y-1 text-amber-800">
                  <li>
                    You may receive marketing text messages and SMS
                    communications from CallMaker24.
                  </li>
                  <li>
                  ...
                  <li>
                    Reply <strong>STOP</strong> to unsubscribe from SMS messages
                    at any time.
                  </li>
                  <li>
                  ...
                  <li>
                    SMS consent is not a condition of purchasing any service.
                  </li>
                </ul>
              </div>
              <p className="mt-3">
                When sending SMS messages to your own customers through our
                platform, you are responsible for obtaining proper consent in
                compliance with the Telephone Consumer Protection Act (TCPA),
                CAN-SPAM Act, and all other applicable telecommunications
                regulations.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                We offer tiered subscription plans (Starter, Elite, Pro,
                Enterprise) with monthly and annual billing options. Current
                pricing is available on our subscription page. We reserve the
              ...
              <p>
                New accounts may receive a 30-day free trial. After the trial
                period, you must subscribe to a paid plan to continue using
                premium features.
              </p>
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Stripe:</strong> For direct signup users, payments are
                  processed securely through Stripe.
                </li>
                <li>
                  <strong>Shopify Billing:</strong> For merchants who install
                  CallMaker24 through the Shopify App Store, billing is handled
                  exclusively through Shopify&apos;s Billing API, as required by
                  Shopify.
                </li>
              </ul>
              ...
              <p>
                ...
                period. Annual subscriptions cancelled within the first 14 days
                may be eligible for a prorated refund.
              </p>
              ...
              <p>
                ...
                billing period. Your account will be downgraded to the free
                tier.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-1 mt-2">
                ...
                <li>
                  ...
                  Stripe checkout is not available for Shopify merchants.
                </li>
                <li>
                  Uninstalling the app will cancel your subscription and trigger
                  data deletion within 48 hours.
                </li>
                <li>
                  We access only the Shopify store data for which you grant
                  permissions during app installation.
                </li>
                <li>
                  You may revoke data access at any time by uninstalling the app
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-1 mt-2">
                ...
                <li>
                  Not upload or transmit harmful, illegal, or infringing
                  content.
                </li>
                <li>
                ...
                <li>
                  Not use the Service for spam, phishing, or other abusive
                  communications.
                </li>
                <li>
                  Comply with the CAN-SPAM Act, TCPA, GDPR, and other applicable
                  regulations when using our communication tools.
                </li>
                <li>
                  Maintain accurate customer opt-in/opt-out records for SMS and
                  email campaigns.
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p>
                The Service, including its design, features, code,
                documentation, logos, and trademarks, is owned by Mtsryde
                Holdings LLC and protected by intellectual property laws. You
              ...
              <p>
                ...
                (customer lists, campaigns, templates, etc.). You grant us a
                limited, non-exclusive license to use your content solely for
            ...
            <section>
              ...
              <p>
                You agree to indemnify, defend, and hold harmless Mtsryde
                Holdings LLC, its officers, directors, employees, and agents
              ...
              <ul className="list-disc pl-6 space-y-1 mt-2">
                ...
                <li>
                  Any content you upload, transmit, or distribute through the
                  Service.
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                immediately. We will retain your data for 30 days to allow for
                data export, after which it will be permanently deleted, except
                as required by law.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                laws of the State of Minnesota, United States, without regard to
                conflict of law principles. Any legal action not subject to
                arbitration shall be brought in the state or federal courts
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-1 mt-2">
                <li>
                  API access is subject to rate limits based on your
                  subscription plan.
                </li>
                <li>
                  You must keep API keys confidential and not share them
                  publicly.
                </li>
                <li>
                  Excessive or abusive API usage may result in throttling or
                  suspension.
                </li>
            ...
            <section>
              ...
              <p>
                ...
                before taking effect. Your continued use of the Service after
            ...
            <section>
              ...
              <p>
                ...
                between you and Mtsryde Holdings LLC regarding the Service.
              </p>
            </section>
