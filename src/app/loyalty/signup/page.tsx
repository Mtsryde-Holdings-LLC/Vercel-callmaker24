    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-purple-50 to-blue-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full text-center">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-4">Welcome to the Club!</h1>
          <p className="text-gray-600 mb-6">
            You're now a loyalty member! Start earning points on your next purchase.
          </p>
          <div className="bg-purple-50 rounded-lg p-4">
            <p className="text-sm text-purple-900">Check your email for your welcome bonus!</p>
          </div>
        </div>
      </div>
    )
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-blue-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Earn points, get rewards, enjoy exclusive benefits</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-purple-500"
            />
            <p className="text-xs text-gray-500 mt-1">🎁 Get special birthday rewards!</p>
          </div>
