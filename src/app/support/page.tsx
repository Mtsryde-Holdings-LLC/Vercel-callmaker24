...
export const metadata: Metadata = {
  ...
  description: 'Get help with CallMaker24 — documentation, guides, FAQ, and contact support.',
}

const features = [
  {
    title: 'Email Campaigns',
    description: 'Create and send professional email campaigns with drag-and-drop templates, scheduling, and analytics.',
    icon: '✉️',
    docs: [
  ...
  {
    title: 'SMS Messaging',
    description: 'Send text message campaigns with opt-in/opt-out management and TCPA compliance.',
    icon: '💬',
    docs: [
  ...
  },
  {
    ...
    description: 'Automated phone system with call routing, recording, and analytics powered by AWS Connect.',
    icon: '📞',
    docs: [
  ...
  {
    title: 'AI Chatbot',
    description: 'AI-powered chatbot for your website that handles customer inquiries 24/7.',
    icon: '🤖',
    docs: [
  ...
  {
    title: 'Social Media',
    description: 'Manage Facebook and Instagram posts, scheduling, and engagement from one dashboard.',
    icon: '📱',
    docs: [
  ...
  },
  {
    ...
    description: 'Customer loyalty program with points, tiers, and automated reward notifications.',
    icon: '⭐',
    docs: [
  ...
  },
  {
    ...
    description: 'Sync your Shopify store customers, orders, and products automatically.',
    icon: '🛍️',
    docs: [
  ...
  {
    title: 'CRM & Contacts',
    description: 'Manage customer relationships, segments, and communication history.',
    icon: '👥',
    docs: [
      ...
      <header className="bg-white border-b">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-6 text-sm">
            ...
            <Link href="/auth/signin" className="text-blue-600 hover:text-blue-700 font-medium">Sign In</Link>
          </nav>
        </div>
      </header>
      ...
      <div className="bg-gradient-to-br from-blue-600 to-blue-800 text-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
          ...
          <p className="text-xl text-blue-100 max-w-2xl mx-auto">
            Everything you need to get the most out of CallMaker24. Guides, documentation, and answers to common questions.
          </p>
        </div>
      </div>
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="bg-white rounded-xl shadow-sm border p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center p-6 rounded-lg bg-blue-50">
                ...
                <a href="mailto:support@callmaker24.com" className="text-blue-600 hover:underline">
              ...
              <div className="text-center p-6 rounded-lg bg-green-50">
                ...
                <a href="tel:+16125408684" className="text-blue-600 hover:underline">
                  612-540-8684
                </a>
                <p className="text-sm text-gray-500 mt-1">Mon–Fri, 9 AM – 5 PM CT</p>
              </div>
              <div className="text-center p-6 rounded-lg bg-purple-50">
                <div className="text-3xl mb-3">💬</div>
                <h3 className="font-semibold text-gray-900 mb-1">Live Chat</h3>
                <p className="text-gray-700">Available in your dashboard</p>
                <p className="text-sm text-gray-500 mt-1">AI-powered + human escalation</p>
              </div>
            </div>
          </div>
        </section>
            ...
            <ol className="space-y-6">
              <li className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-1">Sign up at <a href="https://callmaker24.com" className="text-blue-600 hover:underline">callmaker24.com</a> with your email, Google, or Facebook account. Complete the onboarding wizard to set up your organization.</p>
                </div>
              </li>
              <li className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-1">Connect Twilio for SMS/calls, Shopify for e-commerce, and your email provider in Settings → Integrations. Each integration has a guided setup flow.</p>
                </div>
              </li>
              <li className="flex gap-4">
                <span className="flex-shrink-0 w-8 h-8 bg-blue-600 text-white rounded-full flex items-center justify-center font-bold text-sm">3</span>
                <div>
                  <h3 className="font-semibold text-gray-900">Import Your Contacts</h3>
                  <p className="text-gray-600 mt-1">Upload a CSV file, sync from Shopify, or add contacts manually. Create segments to target the right audience for each campaign.</p>
                </div>
              </li>
              <li className="flex gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900">Launch Your First Campaign</h3>
                  <p className="text-gray-600 mt-1">Navigate to Campaigns, choose email or SMS, select your audience, compose your message using templates, and send or schedule.</p>
                </div>
              </li>
              <li className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-1">Monitor delivery rates, opens, clicks, and conversions from your Dashboard. Use insights to optimize future campaigns.</p>
                </div>
              </li>
            </ol>
          </div>
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full text-sm">
                <thead className="bg-gray-50">
                  <tr>
                    <th className="px-6 py-3 text-left font-semibold text-gray-900 border-b">Feature</th>
                    <th className="px-6 py-3 text-center font-semibold text-gray-900 border-b">Starter<br/><span className="font-normal text-gray-500">$49.99/mo</span></th>
                    <th className="px-6 py-3 text-center font-semibold text-blue-600 border-b">Elite<br/><span className="font-normal text-blue-500">$79.99/mo</span></th>
                    <th className="px-6 py-3 text-center font-semibold text-gray-900 border-b">Pro<br/><span className="font-normal text-gray-500">$129.99/mo</span></th>
                    <th className="px-6 py-3 text-center font-semibold text-gray-900 border-b">Enterprise<br/><span className="font-normal text-gray-500">$499.99/mo</span></th>
                  </tr>
                </thead>
                <tbody className="divide-y">
                  <tr><td className="px-6 py-3">Email Campaigns</td><td className="px-6 py-3 text-center">2,500/mo</td><td className="px-6 py-3 text-center">10,000/mo</td><td className="px-6 py-3 text-center">50,000/mo</td><td className="px-6 py-3 text-center">Unlimited</td></tr>
                  <tr><td className="px-6 py-3">SMS Messages</td><td className="px-6 py-3 text-center">500/mo</td><td className="px-6 py-3 text-center">2,000/mo</td><td className="px-6 py-3 text-center">10,000/mo</td><td className="px-6 py-3 text-center">Unlimited</td></tr>
                  <tr><td className="px-6 py-3">AI Chatbot</td><td className="px-6 py-3 text-center">Basic</td><td className="px-6 py-3 text-center">Advanced</td><td className="px-6 py-3 text-center">Advanced</td><td className="px-6 py-3 text-center">Custom</td></tr>
                  <tr><td className="px-6 py-3">IVR / Call Center</td><td className="px-6 py-3 text-center">—</td><td className="px-6 py-3 text-center">✓</td><td className="px-6 py-3 text-center">✓</td><td className="px-6 py-3 text-center">✓</td></tr>
                  <tr><td className="px-6 py-3">Social Media</td><td className="px-6 py-3 text-center">1 account</td><td className="px-6 py-3 text-center">3 accounts</td><td className="px-6 py-3 text-center">10 accounts</td><td className="px-6 py-3 text-center">Unlimited</td></tr>
                  <tr><td className="px-6 py-3">Loyalty Program</td><td className="px-6 py-3 text-center">—</td><td className="px-6 py-3 text-center">✓</td><td className="px-6 py-3 text-center">✓</td><td className="px-6 py-3 text-center">✓</td></tr>
                  <tr><td className="px-6 py-3">Shopify Integration</td><td className="px-6 py-3 text-center">✓</td><td className="px-6 py-3 text-center">✓</td><td className="px-6 py-3 text-center">✓</td><td className="px-6 py-3 text-center">✓</td></tr>
                  <tr><td className="px-6 py-3">API Access</td><td className="px-6 py-3 text-center">—</td><td className="px-6 py-3 text-center">—</td><td className="px-6 py-3 text-center">✓</td><td className="px-6 py-3 text-center">✓</td></tr>
                  <tr><td className="px-6 py-3">Priority Support</td><td className="px-6 py-3 text-center">—</td><td className="px-6 py-3 text-center">—</td><td className="px-6 py-3 text-center">✓</td><td className="px-6 py-3 text-center">✓</td></tr>
                  <tr><td className="px-6 py-3">Annual Discount</td><td className="px-6 py-3 text-center">15%</td><td className="px-6 py-3 text-center">15%</td><td className="px-6 py-3 text-center">15%</td><td className="px-6 py-3 text-center">15%</td></tr>
                </tbody>
              </table>
            </div>
            <div className="px-6 py-4 bg-gray-50 border-t text-center">
              <p className="text-sm text-gray-600">All plans include a <strong>30-day free trial</strong>. <Link href="/dashboard/subscription" className="text-blue-600 hover:underline">View full plan details →</Link></p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <Link href="/legal/privacy" className="bg-white rounded-xl shadow-sm border p-6 hover:border-blue-300 transition-colors">
            ...
            <Link href="/legal/terms" className="bg-white rounded-xl shadow-sm border p-6 hover:border-blue-300 transition-colors">
              <h3 className="font-semibold text-gray-900 mb-1">Terms of Service</h3>
              <p className="text-sm text-gray-500">Usage agreement and billing</p>
            </Link>
            <Link href="/data-deletion" className="bg-white rounded-xl shadow-sm border p-6 hover:border-blue-300 transition-colors">
              <h3 className="font-semibold text-gray-900 mb-1">Data Deletion</h3>
              <p className="text-sm text-gray-500">Request data removal</p>
            </Link>
            <a href="mailto:support@callmaker24.com" className="bg-white rounded-xl shadow-sm border p-6 hover:border-blue-300 transition-colors">
