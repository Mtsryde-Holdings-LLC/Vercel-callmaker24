...
export const APP_DOMAIN = process.env.NEXT_PUBLIC_APP_URL || process.env.NEXTAUTH_URL || 'https://callmaker24.com'
...
export const NOREPLY_EMAIL = process.env.AWS_SES_FROM_EMAIL || 'noreply@callmaker24.com'
export const REWARDS_EMAIL = process.env.EMAIL_FROM || 'rewards@callmaker24.com'
...
export const PRICING = {
  ...
  ENTERPRISE: {
    name: 'Enterprise',
    monthly: 129.99,
    annual: 1325.90,      // ~$110.49/mo → 15 % off
