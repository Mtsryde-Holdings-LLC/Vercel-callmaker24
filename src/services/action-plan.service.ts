...
export class ActionPlanService {
      ...
      actions: [
        {
          ...
          timing: "IMMEDIATE",
          template: {
            subject: "You're one of our top customers — here's a sneak peek 🎉",
        ...
        },
        {
          ...
          description:
            "Invite champions to join a referral program. They're your best advocates — give them a unique referral code with rewards for each friend they bring.",
          channel: "sms",
          priority: "HIGH",
          timing: "WITHIN_3_DAYS",
          template: {
            body: "Hey {firstName}! 🌟 As a valued VIP, share your unique referral link and earn $10 for every friend who orders. Your friends get 10% off too!",
          },
          status: "PENDING",
        },
        {
      ...
      actions: [
        {
          ...
          timing: "IMMEDIATE",
          template: {
            subject: "Picked just for you — new arrivals you'll love",
        ...
        },
        {
          ...
          description:
            "Offer free shipping for 7 days to incentivize the next purchase. High-value customers are already committed — lower the friction.",
          channel: "both",
          priority: "HIGH",
          timing: "WITHIN_3_DAYS",
          template: {
            subject: "Free shipping is on us — 7 days only!",
        ...
        },
        {
          ...
          timing: "WITHIN_14_DAYS",
          template: {
            body: "🔥 VIP Early Access: Our sale starts for you NOW — 24 hours before everyone else! Shop the best deals first: {link}",
          },
          status: "PENDING",
        },
      ],
      ...
      actions: [
        {
          id: "atrisk_1",
          type: "EMAIL_CAMPAIGN",
          title: "We Miss You — Win-Back Email",
          description:
        ...
        },
        {
          ...
          timing: "WITHIN_3_DAYS",
          template: {
            body: "Hey {firstName}, we saved a 20% discount just for you! It expires soon — shop now: {link} Reply STOP to opt out.",
            discountType: "PERCENTAGE",
            discountValue: 20,
          },
          status: "PENDING",
        },
        {
          id: "atrisk_3",
          type: "EMAIL_CAMPAIGN",
          title: "What's New — Product Update Email",
          description:
        ...
        },
        {
          ...
          timing: "WITHIN_14_DAYS",
          template: {
            subject: "Quick question — how can we do better?",
  ...
  private static buildEngagedPlan(
    ...
    return {
      ...
      estimatedImpact: {
        ...
        engagement: "Already High — maintain",
      },
      actions: [
        {
          id: "engaged_1",
          ...
          description:
            "Encourage engaged non-members to join the loyalty program. They're already active — convert them into committed members.",
          channel: "email",
          priority: "HIGH",
          timing: "IMMEDIATE",
          template: {
            subject: "You're already earning love — now earn rewards too!",
        ...
        },
        {
          ...
          timing: "WITHIN_3_DAYS",
          template: {
            subject: "Complete the set — 10% off when you bundle",
        ...
        },
        {
          ...
          timing: "WITHIN_7_DAYS",
          template: {
            body: "🚀 Flash Deal! 15% off for the next 24 hours — just for our most active fans. Use code FLASH15: {link}",
            discountType: "PERCENTAGE",
            discountValue: 15,
          },
          status: "PENDING",
        },
        {
          ...
          timing: "WITHIN_14_DAYS",
          template: {
            subject: "Share your story — get featured + earn rewards",
            body: "We love seeing how you use our products! Share a photo or review and you could be featured on our page — plus earn bonus loyalty points for every review.",
          },
          status: "PENDING",
        },
      ],
      ...
      actions: [
        {
          id: "new_1",
          type: "EMAIL_CAMPAIGN",
          title: "Welcome Series — Brand Story",
          description:
          ...
          timing: "IMMEDIATE",
          template: {
            subject: "Welcome to the family! Here's our story 💛",
        ...
        },
        {
          ...
          timing: "WITHIN_3_DAYS",
          template: {
            subject: "Your next order is 15% off — just for new members",
        ...
        },
        {
          ...
          timing: "WITHIN_7_DAYS",
          template: {
            body: "Welcome to {brand}! 🎉 Stay in the loop for exclusive deals and early access. Reply YES to get a $5 off code for your next order!",
        ...
        },
        {
          ...
          timing: "WITHIN_14_DAYS",
          template: {
            subject: "Start earning rewards — join our loyalty program!",
            body: "Did you know every purchase earns you points toward free products and exclusive perks? Join our loyalty program today and get 25 starter points — on us!",
          },
          status: "PENDING",
        },
      ],
      ...
      actions: [
        {
          ...
          timing: "IMMEDIATE",
          template: {
            subject: "Buy more, save more — up to 20% off bundles!",
        ...
        },
        {
          ...
          timing: "WITHIN_3_DAYS",
          template: {
            subject: "Just dropped — see it before everyone else 👀",
        ...
        },
        {
          ...
          timing: "WITHIN_7_DAYS",
          template: {
            body: "Hey {firstName}! Based on your last order, it might be time to restock. Order now and get free shipping: {link} 📦",
          },
          status: "PENDING",
        },
        {
          ...
          timing: "WITHIN_14_DAYS",
          template: {
            subject: "A little surprise just for you! 🎁",
            body: "You've been such an amazing customer, we wanted to surprise you with 100 bonus loyalty points! Keep shopping and earning — great rewards are waiting.",
          },
          status: "PENDING",
        },
      ],
  ...
  /**
   * Activate a plan — sets status from DRAFT to ACTIVE
   */
